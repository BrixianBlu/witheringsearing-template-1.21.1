...
public class WSBiomes {
    public static final RegistryKey<Biome> WITHERED_FOREST = RegistryKey.of(RegistryKeys.BIOME,
            Identifier.of(WitheringSearing.MOD_ID, "withered_forest"));
